...
public class RezervacijeVDRTest {
  ...
  @Test
  public void max_putnika_20() {

    for (int i = 0; i < 5; i++) {
      agencija.izvrsiKomandu("DRTA Bruno Bruno 7 " + datumVrijeme("1.7.2025 8:" + (10 + i)));
    }

    agencija.izvrsiKomandu("DRTA Bruno Bruno 7 " + datumVrijeme("1.7.2025 10:00"));
    // postaje odgođena

    List<String> redci = rezervacijeAranzmana(agencija, "7");
  ...
  public void max_putnika_30() {
    ...
    agencija.izvrsiKomandu("DRTA Bruno Bruno 8 " + datumVrijeme("1.7.2025 10:00"));
    // postaje odgođena
